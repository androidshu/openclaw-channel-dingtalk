...
describe('config advanced', () => {
    ...
    it('resolveRelativePath expands home and normalizes absolute/relative path', () => {
        ...
        expect(resolveRelativePath('C:\\Users\\testuser\\a\\b.png')).toBe(
            path.win32.normalize('C:\\Users\\testuser\\a\\b.png'),
        );
        expect(resolveRelativePath('C:/Users/testuser/a/b.png')).toBe(
            path.win32.normalize('C:/Users/testuser/a/b.png'),
        );
    });
    ...
    it('resolveRelativePath recovers stripped leading slash for .openclaw workspace paths on Windows', () => {
        ...
        const input = 'Users\\testuser\\.openclaw\\workspace\\card.png';
